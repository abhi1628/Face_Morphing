...
img = cv2.imread(r"C:\\Users\\Global\\Documents\\ocv\\daniel.jpg")
img2 = cv2.imread(r"C:\\Users\\Global\\Documents\\ocv\\ledger.jpg")

#left , right eyes and mouse 
pts1 = np.array([[218, 240],[295, 240],[250, 383]],np.float32)
#pts1 = np.array([[360, 186],[540, 186],[450, 530]],np.float32)

pts2 = np.array([[248, 245],[345, 270],[281, 366]],np.float32)
#pts2 = np.array([[341, 487],[549, 490],[448, 730]],np.float32)

pts11 =np.zeros((3,2),np.float32)
pts22 =np.zeros((3,2),np.float32)

dis = 300.0 # iterations 
piece = 1.0 / dis
